...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 56412)), "/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/(DashboardLayout)/notification-details/page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 72520)), "/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/(DashboardLayout)/layout.tsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5886)), "/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/(DashboardLayout)/loading.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74053)), "/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/layout.tsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 88924)), "/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/loading.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73881))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/(DashboardLayout)/notification-details/page.tsx"];

    

    const originalPathname = "/(DashboardLayout)/notification-details/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(DashboardLayout)/notification-details/page","pathname":"/notification-details","bundlePath":"app/(DashboardLayout)/notification-details/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36606))
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const fetchNotification = async ()=>{
            if (camera_id && frame_id) {
                try {
                    const response = await fetch(`http://13.239.150.70:8000/notifications/${camera_id}/${frame_id}`);
                    if (!response.ok) {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_3__.Typography, {
                                        children: [
                                            ...
                                            " ",
                                            notification.camera_last_maintenance
                                        ]
                                    })
                                ]
                            })
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NotificationDetails);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/thainguyen/Working/Neuweb/DashboardResponsive/src/app/(DashboardLayout)/notification-details/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [697,433,37], () => (__webpack_exec__(31509)));
